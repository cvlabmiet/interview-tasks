...
На первый взгляд кажется, что тут всё понятно.
Надо просто сесть и написать.
Но лучше приглядеться к задаче повнимательнее.

Требуется написать программу, которая побитово разбирает файл и производите некоторые манипуляции согласно файл-описанию.

...
Ширина и высота видео в формате ``MP4``
    Согласно стандарту `MPEG-4 Part 14<https://en.wikipedia.org/wiki/MPEG-4_Part_14>`_ ширина и высота видео хранится в боксе описания
    для видео кодека.
    Маршрут его поиска по боксам такой: moov -> trak -> ftyp -> vide -> tkhd.
    Каждый бокс представляет из себя структуру: размер, кодовое слово, данные.
